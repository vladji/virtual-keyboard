...
const keysDefault = [
  ...
  [{ val: 'Tab', class: 'def' }, { val: 'й', class: 'switch' }, { val: 'ц', class: 'switch' }, { val: 'у', class: 'switch' }, { val: 'к', class: 'switch' }, { val: 'е', class: 'switch' }, { val: 'н', class: 'switch' }, { val: 'г', class: 'switch' }, { val: 'ш', class: 'switch' }, { val: 'щ', class: 'switch' }, { val: 'з', class: 'switch' }, { val: 'х', class: 'switch' }, { val: 'ъ', class: 'switch' }, { val: '/', class: 'def' }, { val: 'DEL', class: 'def del' }],
  ...
  [{ val: 'Shift', class: 'def shift' }, { val: 'я', class: 'switch' }, { val: 'ч', class: 'switch' }, { val: 'с', class: 'switch' }, { val: 'м', class: 'switch' }, { val: 'и', class: 'switch' }, { val: 'т', class: 'switch' }, { val: 'ь', class: 'switch' }, { val: 'б', class: 'switch' }, { val: 'ю', class: 'switch' }, { val: '.', class: 'def' }, { val: '&#9650;', class: 'def arrow-up' }, { val: 'Shift', class: 'def shift' }],
