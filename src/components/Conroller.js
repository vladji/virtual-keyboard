...
const keysDefault = [
  ...
  [{ val: 'Shift', class: 'def shift ShiftLeft' }, { val: 'я', class: 'switch print KeyZ' }, { val: 'ч', class: 'switch print KeyX' }, { val: 'с', class: 'switch print KeyC' }, { val: 'м', class: 'switch print KeyV' }, { val: 'и', class: 'switch print KeyB' }, { val: 'т', class: 'switch print KeyN' }, { val: 'ь', class: 'switch print KeyM' }, { val: 'б', class: 'switch print Comma' }, { val: 'ю', class: 'switch print Period' }, { val: '.', class: 'def symb print Slash' }, { val: '&#9650;', class: 'def arrow-up ArrowUp' }, { val: 'Shift', class: 'def shift ShiftRight' }],
...
export default class Controller {
  ...
  lesteners() {
    ...
    keybord.addEventListener('mousedown', (e) => {
      ...
      if (!e.target.classList.contains('shift') && !e.target.classList.contains('caps')) {
    ...
    keybord.addEventListener('mouseup', (e) => {
      ...
      if (e.target.classList.contains('shift')) model.shift();
      model.keyUp(e);
    });
    ...
    document.body.addEventListener('keydown', (e) => {
      ...
      if (key && !key.classList.contains('shift')) model.keyDown(key);
      if (key && key.classList.contains('shift')) model.shift();
      return true;
    });
    ...
    document.body.addEventListener('keyup', (e) => {
      ...
      if (key) {
        model.keyUp(key);
        if (key.classList.contains('shift')) model.shift();
      }
    });
  }
}
